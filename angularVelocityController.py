...
class VehicleSimpleDynamic:
    ...
    def rightParts(self, rotorsAngularVel): #rotorsAngularVel: float угловая скорость двигателей
        rotorsAngularVelSum = 0
        for i in range(self.rotorCount): # суммируем квадрат заданной угловой скорости для всех двигателей
            rotorsAngularVelSum += rotorsAngularVel**2
        # Вычисляем ускорение нашей системы. Получаем силу тяги создаваемую всеми двигателями 
    ...
    def getPosition(self):
        return self.position  # положение ЛА

    def getVelocity(self):
        return self.velocity #скорость ЛА

    def getAcceleration(self):
        return self.acceleration # ускорение
...
class ControlSystem():
    ...
    def setDesiredPosition(self, desiredPosition):
        ...
        self.desiredPosition = desiredPosition  # целевое положение ЛА
